...
| P11-104 | WEB-SABR 请求体对齐 FreeTube HAR 实测形状:clientInfo 砍到 4 字段+bandwidthEstimate 真实值+显式零值省略+bitfield video 省略(webShape 按 clientName==1 分流,visionOS 路径不动) | Done(代码完成,待云编译+真机) |
