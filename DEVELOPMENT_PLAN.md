...
| P11-82 | WebDAV 备份/还原纳入 TVBox 配置:新增 WebDavBackupItem.Tvbox,备份 tvboxConfigUrl 到 bilitv/tvbox_config.json,还原写回 setTvboxConfigUrl(缺文件/解析失败跳过);TV/移动选择弹窗还原列表加 Tvbox 项;strings 4 locale | 实施中(代码完成待云编译) |
